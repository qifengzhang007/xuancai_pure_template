...
/// @param iRow   开始行
/// @param nRows  改变行数量
#define  XE_EDITOR_MODIFY_ROWS      186  //多行内容修改事件
...
/// @defgroup  groupListDrawItemBkFlags  项背景绘制标志位(List,ListBox,ListView,Tree)
/// @{
...
///@defgroup group_bkInfo_align_flags_  背景对象对齐方式(bkObject_align_flag_)
///@{
